/**
 * Pool factory contract with fixed apr
 */
...
// File: contracts/NFTGFixedPoolInitializable.sol
...
contract NFTGFixedPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
...
// File: contracts/NFTGFixedPoolFactory.sol

pragma solidity 0.6.12;

contract NFTGFixedPoolFactory is Ownable {
    event NewNFTGFixedPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(NFTGFixedPoolInitializable).creationCode;
        ...
        NFTGFixedPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerToken,
            _startBlock,
        ...
        emit NewNFTGFixedPoolContract(smartChefAddress);
    }
}
