...
// File: contracts/NFTGPoolInitializable.sol

pragma solidity 0.6.12;

contract NFTGPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public NFTG_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == NFTG_POOL_FACTORY, "Not factory");
    ...
    function emergencyRewardWithdraw(uint256 _amount) external onlyOwner {
        require(startBlock > block.number || endBlock < block.number, "Not allowed to remove reward tokens while pool is live");
...
// File: contracts/NFTGPoolFactory.sol

pragma solidity 0.6.12;

contract NFTGPoolFactory is Ownable {
    event NewNFTGPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(NFTGPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        NFTGPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewNFTGPoolContract(smartChefAddress);
    }
}
